	...
	return (
		<>
            ...
            // Just leave this be.
					...
					// overlay={true}
					containerClasses={
						"cookie-banner xs:rounded-lg text-blue-900 flex gap-4 flex-col fixed px-3 py-4 gap-4 text-3 bg-white shadow-soft border-t xs:border border-blue-500 transition-all duration-300 bottom-0 right-0 left-0 xs:bottom-4 xs:right-4 xs:left-auto z-99999"
					}
					buttonClasses={
						"bg-blue-500 color-white hover:bg-blue-600 focus:bg-blue-600 cursor-pointer text-4 py-2 px-3 leading-5 font-semibold text-white rounded-full order-1 transition-colors duration-200"
					}
					declineButtonClasses={
						"bg-transparent color-white border-blue-300 border order-2 hover:border-blue-500 hover:text-blue-500 transition-colors duration-200 cursor-pointer text-4 py-2 px-3 leading-5 font-semibold text-blue-500 rounded-full"
					}
            ...
            // This is where we set the state for allowCookies
				...
				>
					<span>
						We use cookies (and other similar technologies) to provide a more
						relevant browsing experience on our site and personalize content and
						advertising on our site and other websites. By using our website,
						you&apos;re agreeing to the collection, use, and disclosure of data
						as described in our{" "}
						<Link href="https://convertkit.com/privacy">
							Privacy Policy
						</Link>
						.
					</span>
